...
<tab id="objectsForReview" label="{translate key="plugins.generic.objectsForReview.tabTitle"}">
	{capture assign="objectsForReviewGridUrl"}{url router=PKP\core\PKPApplication::ROUTE_COMPONENT  component="plugins.generic.objectsForReview.controllers.grid.ObjectsForReviewManagementGridHandler" op="fetchGrid" escape=false}{/capture}
